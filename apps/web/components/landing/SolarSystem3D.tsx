...
const Sun = ({ onClick }: { onClick: (data: PlanetData) => void }) => {
  ...
  const sunData: PlanetData = {
    ...
    distStr: 'Pusat (0 km)',
    revStr: '-',
    facts: 'Bintang pusat tata surya kita. Sangat panas dan bercahaya!'
  };
  ...
  return (
    ...
    >
      ...
      {/* High intensity point light to illuminate the entire system for kids! */}
      <pointLight intensity={200} distance={800} color="#ffffee" decay={1} />
      <pointLight intensity={100} distance={400} color="#ffaa00" decay={1} />
      
      {/* Visual Glow Layers - Vibrant! */}
      ...
      <mesh scale={[1.5, 1.5, 1.5]}>
        <sphereGeometry args={[6, 32, 32]} />
        <meshBasicMaterial color="#ff6600" transparent opacity={0.1} side={THREE.BackSide} />
      </mesh>
    </group>
  );
};
  ...
  return (
    <div className="w-full h-full bg-[#020617]">
      <Canvas dpr={[1, 2]} gl={{ antialias: true, alpha: true }}>
        ...
        <Stars radius={300} depth={60} count={5000} factor={5} saturation={1} fade speed={2} />
